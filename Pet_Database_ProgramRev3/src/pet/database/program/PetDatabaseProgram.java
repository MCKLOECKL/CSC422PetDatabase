                ...
                switch(menuSelection){
                    ...
                    case 3 -> {
                        System.out.println("""
                            ...
                            System.out.println(petAgeList.size() + " rows in set");
                            System.out.println();
                            System.out.println("Enter the pet name you want to update: ");
                            String petToChange = input.nextLine();
                            ...
                            int petAge = Integer.parseInt(petAgeResponse[1]);
                                petAgeList.put(pet, petAge);
                            petAgeList.remove(petToChange);
                            System.out.println(petToChange + " changed to " + response);
                     break;   
                    }
                    ...
                    case 4 -> {
                        System.out.println("""
                            ...
                            String petToRemove = input.nextLine();
                            petAgeList.remove(petToRemove);
